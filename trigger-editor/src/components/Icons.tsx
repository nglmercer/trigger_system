...
// Condition Icon - balance/scale (like ⚖)
...
// Condition Group Icon - folder
export const ConditionGroupIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Action Group Icon - grid of 4 squares
export const ActionGroupIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Grid Icon - 2x2 grid (for sidebar toggle)
...
// JSON/Code Brackets Icon (different from CodeIcon)
export const BracketsIcon = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
